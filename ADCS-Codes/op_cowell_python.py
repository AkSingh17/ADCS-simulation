...
if __name__ == "__main__":
    s = np.array([6426.223005055448,-3104.6548630621883,1173.6531793284134,2.7585664673600765, 6.528957246086595,2.234663895882369])
    t0, tf = 0, 10
    out_file = open('/home/erebus/Documents/parikshit/adcs_codes/ADCS-Codes/cowell_position.txt','w')
    for i in range(1,tf):
        final = propagate_state(s,t0,i)
        final_str = str(final[0:3])
